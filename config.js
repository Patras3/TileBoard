 ...
 * ======================================================================
 *
 * This configuration uses refactored TileBoard services:
 ...
 * - All utility functions (scripts/globals/utils.js)
 *
 * See REFACTORING_GUIDE.md for documentation.
 */
...
// Services are loaded via scripts/globals.js and available on window object
const NotificationManager = window.NotificationManager || {
   openFullScreen: () => console.warn('NotificationManager not yet loaded'),
   openCorner: () => console.warn('NotificationManager not yet loaded'),
   close: () => console.warn('NotificationManager not yet loaded'),
};
